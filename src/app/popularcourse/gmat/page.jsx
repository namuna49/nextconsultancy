        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-xl text-blue-900 mb-8 leading-relaxed">
              Expert coaching, personalized attention, and proven results. Join
              500+ successful students who achieved their dream B-school
              admission.
            </p>
            ...
            <div className="flex flex-wrap gap-4 mb-10">
              ...
              <button className="px-8 py-4 bg-purple-200 border-2 border-white text-shadow-blue-900 font-bold rounded-lg hover:bg-purple-300 hover:text-blue-900 transition-all duration-300">
                Download Syllabus
              </button>
            </div>
...
const CourseFeatures = () => {
  ...
  const content = {
    ...
    curriculum: [
      "Quantitative Reasoning - 40+ hours of intensive training",
      "Verbal Reasoning - 35+ hours with practice drills",
      "Integrated Reasoning - 15+ hours of problem-solving",
      "Analytical Writing - 10+ hours with essay reviews",
    ],
    schedule: [
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-600 text-lg">
            Everything you need to know about our GMAT program
          </p>
        </motion.div>
    ...
    <div className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-600 text-lg">
            We provide comprehensive training with a proven track record
          </p>
        </motion.div>
...
const StatsSection = () => {
  const stats = [
    ...
    { number: "720+", label: "Average Score", icon: Target },
    { number: "100%", label: "Job Placement", icon: Award },
  ];
...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      text: "Best decision I made for my GMAT prep.  Highly recommend this program to everyone.",
      school: "Stanford GSB",
    },
    {
      name: "Priya Sharma",
      ...
      text: "The mock tests were very helpful.  I felt confident walking into the actual exam.",
  ...
  const highlights = [
    {
      ...
      desc: "Learn from certified professionals with 10+ years of experience and proven track records.",
    },
    {
      title: "Flexible Study Schedule",
      desc: "Choose from morning, evening, or weekend batches that fit your schedule.",
    },
    {
      title: "Full-Length Practice Tests",
      desc: "Take unlimited mock exams that simulate real GMAT conditions.",
    },
    {
      title: "Personalized Feedback",
      desc: "Get one-on-one mentoring with customized study plans.",
    },
    {
      title: "Premium Study Materials",
      desc: "Access 1000+ practice questions, video lessons, and e-books.",
    },
    {
      title: "Post-Exam Support",
      desc: "Receive guidance on MBA applications and interview preparation.",
    },
  ];
